<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="recordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="进出类型0进入1出" align="center" prop="accessType" />
      <el-table-column label="出：目的地；进：来源地" align="center" prop="destination" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="出：目的地；进：来源地" prop="destination">
          <el-input v-model="form.destination" placeholder="请输入出：目的地；进：来源地" />
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        accessType: [
          { required: true, message: "进出类型0进入1出不能为空", trigger: "change" }
        ]
      }
    };
  },
