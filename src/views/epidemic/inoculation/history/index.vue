...
<script>
import { listHistory, getHistory, delHistory, addHistory, updateHistory } from "@/api/epidemic/inoculation/history";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除疫苗接种记录编号为"' + historyIds + '"的数据项？').then(function () {
